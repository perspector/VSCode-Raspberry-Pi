# VSCode-Raspberry-Pi
## _Note: You can now officially download vscode from Microsoft [here](https://code.visualstudio.com/#alt-downloads) for Raspberry Pi ARM (32 bit) or ARM64 (64 bit)._
